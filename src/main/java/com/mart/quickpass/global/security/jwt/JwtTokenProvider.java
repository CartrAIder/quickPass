...
public class JwtTokenProvider {
    ...
    public String createAccessToken(Long userId, String email) {
        return createToken(userId, email, TYPE_ACCESS, jwtProperties.accessTokenValidity());
    }
    ...
    private String createToken(Long userId, String email, String type, long validityMillis) {
        Date now = new Date();
